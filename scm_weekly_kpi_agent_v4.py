...
# ─────────────────────────────────────────────────────────
#  KPI 계산 — 품절 KPI (sales_status_history 이력 기반)
# ─────────────────────────────────────────────────────────
...
version: v4.0
team: 외주생산파트
generated_by: scm_weekly_kpi_agent_v4.0
---
...
*Generated by scm_weekly_kpi_agent v4.0 — {datetime.datetime.now().strftime('%Y-%m-%d %H:%M')}*
"""
...
def main():
    parser = argparse.ArgumentParser(description="SCM 주간 KPI 자동화 에이전트 v4.0")
